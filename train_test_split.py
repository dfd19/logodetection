...
train_path = os.path.join('custom_dataset','train')
val_path = os.path.join('custom_dataset','val')
...
for imgName in train_images:
    ...
    og_txt_path = os.path.join('bbox_txt', Path(imgName).stem+ '.txt')
    target_txt_path = os.path.join(train_path, Path(imgName).stem+ '.txt')
...
for imgName in val_images:
    ...
    og_txt_path = os.path.join('bbox_txt', Path(imgName).stem+ '.txt')
    target_txt_path = os.path.join(val_path, Path(imgName).stem+ '.txt')
